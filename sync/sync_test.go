...
func TestCounter(t *testing.T) {
	...
	t.Run("it runs safely concurrently", func(t *testing.T) {
		...
		// calls Add to set the number of goroutines to wait for. Then each of the goroutines
		// runs and calls Done when finished. At the same time, Wait can be used to block
