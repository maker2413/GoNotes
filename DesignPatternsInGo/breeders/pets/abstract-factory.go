...
// PetFactoryInterface is the interface for our DogAbstractFactory and CatAbstractFactory
// functions. Both of these types must implement a newPet method which returns a type that
